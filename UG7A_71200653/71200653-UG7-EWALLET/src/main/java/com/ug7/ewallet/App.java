...
public class App {
    public static void main(String[] args) {
        ...
        User U_71200653 = new User("Davin Dipa Wijaya", "davin.dipa@ti.ukdw.ac.id", 30000);

        ShopeePay E_71190480 = new ShopeePay(U_71190480);
        GoPay E_71200653 = new GoPay(U_71200653);
        ...
        System.out.println("\n========== TOP UP #1 ==========");
        System.out.print("["+E_71200653.getUser().getNama()+"] - ");
        E_71200653.topup(10000);
        ...
        System.out.println("\n========== TOP UP #3 ==========");
        System.out.print("["+E_71200653.getUser().getNama()+"] - ");
        E_71200653.topup(50000);
        System.out.print("["+E_71200653.getUser().getNama()+"] - ");
        E_71200653.topup(9000);

        System.out.println("\n========== TRANSFER #1 ==========");
        System.out.print("["+E_71190480.getUser().getNama()+"] - ");
        E_71190480.transfer(E_71200653, 2500);
        ...
        System.out.println("\n========== TRANSER #3 ==========");
        System.out.print("["+E_71200653.getUser().getNama()+"] - ");
        E_71200653.transfer(E_71190480, 9500);

        System.out.println("\n========== WITHDRAW #1 ==========");
        System.out.print("["+E_71190480.getUser().getNama()+"] - ");
        E_71190480.withdraw(11000);
        System.out.print("["+E_71200653.getUser().getNama()+"] - ");
        E_71200653.withdraw(1100);
